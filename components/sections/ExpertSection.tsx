...
const experts = [
  ...
  {
    name: 'Erik Bühne',
    specialization: 'Collectibles & Asiatika',
  ...
  },
  {
    ...
    specialization: 'Immobilien Fahrzeuge',
  ...
  {
    name: 'Lars Bühne',
    specialization: 'Contemporary Arts & Design',
  ...
  return (
    <section className="bg-primary text-white md:py-16 py-8 px-4 md:px-8">
      <div className="md:max-w-xl flex flex-col justify-between items-start md:ml-44 mb-8 md:mb-12">
        ...
        Gemeinsam bündeln wir unsere Expertise
        und unsere Netzwerke, um Ihre Vermögenswerte mit Weitsicht, Diskretion und
        Verantwortungsbewusstsein für Sie zu verwerten
        </p>
      </div>
