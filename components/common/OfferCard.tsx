...
const OfferCard = ({number, title, description}: {number: number, title: string, description: string}) => {
  ...
  return (
    <div className={`bg-white rounded-lg p-6 flex flex-col gap-6 md:w-[21vw] w-[90%] mx-6 md:mx-0 ${isExpanded ? 'h-auto' : 'h-[350px]'} pb-10`}>
        ...
        <div className='text-primary md:text-lg text-lg font-semibold'>{title}</div>
